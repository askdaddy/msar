...
class IO(IPlugin):
    ...
    def run(self):
        if self.cop.args.io is not True and self.cop.args.all is not True:
            return
        ...
        self.cop.out({self.__class__.__name__: self.records})
